...
defineProps({
  title: { type: String, default: "Data to enrich your online business" },
  subTitle: {
    type: String,
    default:
...
<template>
  <div class="relative isolate px-10 pt-4 lg:px-1">
    <div
    ...
    <div class="mx-auto max-w-2xl py-32 sm:py-4 lg:py-8">
